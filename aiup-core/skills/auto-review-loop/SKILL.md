...
3. **Critique**: The agent plays the role of a Senior Architect. Are all Alternative Flows handled? Are there any security risks? Are the project's architectural patterns respected? Are tests passing?
